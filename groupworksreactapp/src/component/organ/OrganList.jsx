...
const OrganList = () => {
    ...
    const loadOrganVoList = () => {
        ...
        fetch(`${process.env.REACT_APP_GROUPWORKS_API_URL}/app/organ/list?loginMemberNo=${loginMemberNo}`)
        .then(resp => resp.json())
        .then(data => {
    ...
    const handleDelete = no => {
        fetch(`${process.env.REACT_APP_GROUPWORKS_API_URL}/app/organ/delete/${no}`, {
            method: 'DELETE',
            headers: {
