...
const BusinessTripFormList = ({}) => {
    ...
    useEffect( () => {
        fetch(`${process.env.REACT_APP_GROUPWORKS_API_URL}/app/api/business-trip-form/list?writerNo=${loginMemberNo}&page=${currentPage}&limit=${limit}`)
        .then( resp => resp.json() )
        .then( data => {
            if(data.msg === 'good'){
    ...
    const loadApplyList = () => {
        fetch(`${process.env.REACT_APP_GROUPWORKS_API_URL}/app/api/business-trip-form/apply-list?loginMemberNo=${loginMemberNo}&page=${applyCurrentPage}&limit=${limit}`)
        .then( resp => resp.json() )
        .then( data => {
            if(data.msg === 'good'){
    ...
    const handleDelete =(vacationNo) => {
        fetch(`${process.env.REACT_APP_GROUPWORKS_API_URL}/app/api/business-trip-form/delete`, {
            method:'POST',
            headers: {
    ...
    const url = `${process.env.REACT_APP_GROUPWORKS_API_URL}/app/api/business-trip-form/login-member?no=${queryParam}`;
    ...
    const handleApplyClick = (vacationNo) => {
        ...
        if(isConfirmed) {
            fetch(`${process.env.REACT_APP_GROUPWORKS_API_URL}/app/api/business-trip-form/apply`,{
                method:'POST',
                headers: {
                    'Content-Type' : 'application/json',
                },
    ...
    const handleRejectionClick = () => {
        ...
        if(isConfirmed) {
            fetch(`${process.env.REACT_APP_GROUPWORKS_API_URL}/app/api/business-trip-form/rejection`,{
                method:'POST',
                headers: {
                    'Content-Type' : 'application/json',
                },
